...
class AdminSiteTests(TestCase):
    def setUp(self):
        ...
        self.category = Category.objects.create(name="iPhones", description="Phones")
        self.product = Product.objects.create(
            name="iPhone 15", price=999.00, category=self.category,
            memory="128 GB", battery_capacity="3000", screen_size="6.1", color="Black",
